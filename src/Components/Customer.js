...
function Customer(props) {
  ...
  const renderInvoicesBill = (invoice, index) => {
    return (
      <div
        key={index}
        class="card invoice-card text-white bg-primary mb-3 w-80"
      >
            ...
            >
              ...
              <form className="entry-form">
                ...
                <div className="entry-form-input">
                  ...
                  <input name="Customer_Name" required={true} ref={register({ pattern: /^[A-Za-z]+$/i })} />
                </div>
                <div className="entry-form-input">
                  <label htmlFor="Contact_Number">Contact Number</label>
                  <input name="Contact_Number" required={true} ref={register({ pattern: /^[A-Za-z]+$/i },{ min: 5, max: 10 })} />
                </div>
                <div className="entry-form-input">
                  ...
                  <textarea
                    ...
                    rows={3}
                    required={true}
                    ref={register({ pattern: /^[A-Za-z0-9_/-]+$/i })}
                  />
                </div>
                <div className="entry-form-input">
                  <label htmlFor="Email">Email</label>
                  <input name="Email" required={true} ref={register({ pattern: /^[A-Za-z0-9+_.-]+@[A-Za-z0-9.-]+$/i })} />
                </div>
                <div className="entry-form-input">
                  <label htmlFor="Car_Number">Car Number</label>
                  <input name="Car_Number" required={true} ref={register({ pattern: /^[A-Za-z0-9]+$/i },{ min: 5, max: 10 })} />
                </div>
                <div className="entry-form-input">
